...
import 'package:third_hand_2_0/constants/validators.dart';
...
class _UserFormReviewState extends State<UserFormReview> {
  ...
  void initState() {
    ...
    _countryCodeController = TextEditingController(text: '+880');
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      'Urgency ${categoryProvider.formData['urgency_level']}',
                      style: TextStyle(
                        color: blackColor,
                        fontWeight: FontWeight.bold,
                      ),
                        ...
                        onPressed: () async {
                          ...
                          await updateUserProductData(
                                  categoryProvider,
                                  {
                                    'contact_details': {
                                      'mobile':
                                          '+880${_phoneNumberController.text}',
    ...
    return Form(
      ...
      child: FutureBuilder<DocumentSnapshot>(
          ...
          builder:
            ...
            _phoneNumberController.text = snapshot.data!['mobile'].substring(4,14) ?? '';
